    ...
    if (ImGui::BeginTabBar("settingsTab")) {
      ...
      CONFIG_SECTION("Keyboard") {
        ...
        if (ImGui::TreeNode("Global hotkeys")) {
		  ...
		  UI_KEYBIND_CONFIG(GUI_ACTION_RECORD_PATTERN);
		  ...
		  UI_KEYBIND_CONFIG(GUI_ACTION_OCTAVE1);
		  UI_KEYBIND_CONFIG(GUI_ACTION_OCTAVE2);
		  UI_KEYBIND_CONFIG(GUI_ACTION_OCTAVE3);
		  UI_KEYBIND_CONFIG(GUI_ACTION_OCTAVE4);
		  UI_KEYBIND_CONFIG(GUI_ACTION_OCTAVE5);
		  UI_KEYBIND_CONFIG(GUI_ACTION_OCTAVE6);
		  UI_KEYBIND_CONFIG(GUI_ACTION_OCTAVE7);
        ...
        if (ImGui::TreeNode("Pattern")) {
		  ...
		  UI_KEYBIND_CONFIG(GUI_ACTION_PAT_TRACK_CUT);
		  UI_KEYBIND_CONFIG(GUI_ACTION_PAT_TRACK_COPY);
		  UI_KEYBIND_CONFIG(GUI_ACTION_PAT_TRACK_PASTE);
		  UI_KEYBIND_CONFIG(GUI_ACTION_PAT_TRACK_SELECT);
...
void FurnaceGUI::syncSettings() {
  ...
  settings.stepOnDelete=e->getConfInt("stepOnDelete",1);
