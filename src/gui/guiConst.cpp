...
const FurnaceGUIActionDef guiActions[GUI_ACTION_MAX]={
  ...
  D("PLAY", "Play", FURKMOD_CMD|SDLK_RCTRL),
  D("STOP", "Stop", 0),
  D("RECORD_PATTERN", "Rec. ptn.", FURKMOD_SHIFT|SDLK_RSHIFT),
  D("PLAY_START", "Play (from beginning)", 0),
  D("PLAY_REPEAT", "Play (repeat pattern)", FURKMOD_ALT|SDLK_RALT),
  D("PLAY_CURSOR", "Play from cursor", SDLK_MENU),
  ...
  D("OCTAVE1", "Select Octave 1", SDLK_F1),
  D("OCTAVE2", "Select Octave 2", SDLK_F2),
  D("OCTAVE3", "Select Octave 3", SDLK_F3),
  D("OCTAVE4", "Select Octave 4", SDLK_F4),
  D("OCTAVE5", "Select Octave 5", SDLK_F5),
  D("OCTAVE6", "Select Octave 6", SDLK_F6),
  D("OCTAVE7", "Select Octave 7", SDLK_F7),
  D("INS_UP", "Previous instrument", FURKMOD_SHIFT|SDLK_KP_DIVIDE),
  D("INS_DOWN", "Next instrument", FURKMOD_SHIFT|SDLK_KP_MULTIPLY),
  D("STEP_UP", "Increase edit step", SDLK_BACKQUOTE),
  D("STEP_DOWN", "Decrease edit step", FURKMOD_SHIFT|SDLK_BACKQUOTE),
  ...
  D("PAT_TRACK_CUT", "Cut Track", FURKMOD_SHIFT|SDLK_F3),
  D("PAT_TRACK_COPY", "Copy Track", FURKMOD_SHIFT| SDLK_F4),
  D("PAT_TRACK_PASTE", "Paste Track", FURKMOD_SHIFT|SDLK_F5),
  D("PAT_TRACK_SELECT", "SELECT Track", FURKMOD_ALT|SDLK_c),
  ...
  D("PAT_CURSOR_LEFT_CHANNEL", "Move cursor to previous channel", FURKMOD_SHIFT|SDLK_TAB),
  D("PAT_CURSOR_RIGHT_CHANNEL", "Move cursor to next channel", SDLK_TAB),
